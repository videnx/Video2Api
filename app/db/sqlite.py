    ...
    def _init_db(self):
        ...
        cursor.execute(
            ...
            CREATE TABLE IF NOT EXISTS sora_nurture_batches (
                ...
                max_follows_per_profile INTEGER NOT NULL DEFAULT 1,
                max_likes_per_profile INTEGER NOT NULL DEFAULT 3,
                status TEXT NOT NULL,
                success_count INTEGER NOT NULL DEFAULT 0,
                failed_count INTEGER NOT NULL DEFAULT 0,
    ...
    def create_sora_nurture_batch(self, data: Dict[str, Any]) -> int:
        ...
        cursor.execute(
            ...
            (
                ...
                int(data.get("max_follows_per_profile") or 1),
                int(data.get("max_likes_per_profile") or 3),
                str(data.get("status") or "queued"),
